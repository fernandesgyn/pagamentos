  ...
  <div class="card-body">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        ...
        <select id="fornecedor_id" name="fornecedor_id" class="form-select" required data-supplier-select>
          <option value="">Selecione</option>
          <?php foreach($fornecedores as $f):?><option value="<?=e($f['id'])?>" <?=((int)$f['id']===$fornecedorSelecionado)?'selected':''?>><?=e($f['razao_social'])?> — <?=e($f['documento'])?></option><?php endforeach;?>
        </select>
      </div>
      ...
      <div class="col-md-6">
        ...
        <div class="form-text">Somente obrigações do fornecedor selecionado ficam disponíveis.</div>
      </div>
      ...
      <div class="col-md-4"><label class="form-label">Data de emissão do documento *</label><input type="date" name="data_emissao" value="<?=date('Y-m-d')?>" class="form-control" required></div>
      <div class="col-md-4"><label class="form-label">Data do atesto</label><input type="date" name="data_atesto" class="form-control"></div>
      <div class="col-md-4"><label class="form-label">Data Envio à COOINSP</label><input type="date" name="data_envio_cooinsp" class="form-control"></div>
      ...
      <div class="col-md-4"><label class="form-label">Valor líquido *</label><input name="valor_liquido" class="form-control" required placeholder="0,00"></div>
...
<?php unset($obrigacaoSelecionada,$fornecedorSelecionado,$ob);?>
