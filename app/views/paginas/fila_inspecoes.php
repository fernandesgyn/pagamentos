...
<div class="card" data-admin-table data-page-size="<?=$tablePageSize?>">
  ...
  <div class="card-body p-0"><div class="table-responsive"><table class="table table-hover table-striped mb-0 align-middle">
    <thead><tr><th>Documento</th><th>Fornecedor</th><th>Obrigação</th><th>Valor bruto</th><th>Valor líquido</th><th>Envio COOINSP</th><th>Status</th><th class="text-end portal-actions-cell" data-table-nosort>Ações</th></tr></thead>
    <tbody>
      <?php foreach($itens as $i):?><tr data-record-id="<?=e($i['documento_id'])?>">
        ...
        <td><?=e($i['obrigacao_numero'])?>/<?=e($i['obrigacao_ano'])?></td>
        <td><?=money($i['valor_bruto'])?></td>
