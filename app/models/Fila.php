...
final class Fila
{
    ...
    public function inspecoes():array
    {
        return $this->db->query("SELECT d.id documento_id,d.numero documento_numero,d.data_emissao,d.data_envio_cooinsp,d.valor_bruto,d.valor_liquido,d.data_lancamento,
            td.nome tipo_documento,f.razao_social fornecedor,o.numero obrigacao_numero,o.ano obrigacao_ano,s.nome status_inspecao,s.permite_avancar,s.encerra_inspecao,i.data_conclusao,
          ...
          GROUP BY d.id,d.numero,d.data_emissao,d.data_envio_cooinsp,d.valor_bruto,d.valor_liquido,d.data_lancamento,td.nome,f.razao_social,o.numero,o.ano,s.nome,s.permite_avancar,s.encerra_inspecao,i.data_conclusao,s.ordem
    ...
    public function programacao():array
    {
        return $this->db->query("SELECT d.id documento_id,d.numero documento_numero,d.valor_liquido,td.nome tipo_documento,f.razao_social fornecedor,s.nome status_inspecao,
          ...
          JOIN inspecoes i ON i.documento_id=d.id JOIN status_inspecao s ON s.id=i.status_id
          LEFT JOIN parcelas_pagamento p ON p.documento_id=d.id LEFT JOIN liquidacoes l ON l.parcela_id=p.id
